...
# end
  ...
  config.vm.define "flaskRH7" do |flaskRH7|
#   flaskRH7.vm.box = "generic/rhel7"
    flaskRH7.vm.box = "RH7.5_baserepo"
    #flaskRH7.vm.box = "javier-lopez/rhel-7.4"
    #flaskRH7.vm.box = "xianlin/rhel-7.4"
    flaskRH7.vm.hostname = "flaskRH7"
    flaskRH7.vm.network "private_network", ip: "192.168.60.140"
    flaskRH7.vm.provision "shell", :inline => "sudo echo '192.168.60.140 flaskRH7.local flaskRH7' >> /etc/hosts"
    flaskRH7.vm.provision "ansible" do |ansible|
